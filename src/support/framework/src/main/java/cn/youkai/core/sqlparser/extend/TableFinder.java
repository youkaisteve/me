...
public class TableFinder implements SelectItemVisitor, FromItemVisitor, SelectVisitor {
    ...
    public void visit(Table tableName) {
        logger.log(Level.FINE,"visit Table");
    ...
    public void visit(SubSelect subSelect) {
        logger.log(Level.FINE,"visit SubSelect");
    }

    @Override
    public void visit(SubJoin subjoin) {
        logger.log(Level.FINE,"visit SubJoin");
    }

    @Override
    public void visit(LateralSubSelect lateralSubSelect) {
        logger.log(Level.FINE,"visit LateralSubSelect");
    }

    @Override
    public void visit(ValuesList valuesList) {
        logger.log(Level.FINE,"visit ValuesList");
    }

    @Override
    public void visit(TableFunction tableFunction) {
        logger.log(Level.FINE,"visit TableFunction");
    }

    @Override
    public void visit(PlainSelect plainSelect) {
        logger.log(Level.FINE,"visit PlainSelect");
...
//        plainSelect.getWhere().accept(new ExpressionFinder(visitorContext));
    ...
    public void visit(SelectExpressionItem selectExpressionItem) {
        logger.log(Level.FINE, "visit SelectExpressionItem");
